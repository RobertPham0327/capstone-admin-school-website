...
const ContactListItem: React.FC<ContactListItemProps> = ({
  ...
  return (
    ...
    >
      <StyledContactListItemCheckView onClick={event => event.stopPropagation()}>
        <Checkbox
      ...
      <StyledContactListItemTitle className="text-truncate">{contact.name}</StyledContactListItemTitle>
      ...
      <StyledContactListItemAction className="contact-list-item-action">
        <StyledContactListExportIcon style={{ color: onGetLabelColor(contact.label) }} />

        <StyledContactListItemMenuView onClick={event => event.stopPropagation()}>
          <ItemMenu

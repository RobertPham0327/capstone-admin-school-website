...
const AddContactForm: React.FC<AddContactFormProps> = ({
  ...
  const onFinish = (values: any) => {
    if (values.birthday) values.birthday = dayjs(values.birthday).format('DD-MM-YYYY');
    if (selectContact) {
      const newContact = {
        id: selectContact.id,
  ...
  return (
    <StyledContactForm
      ...
      initialValues={
        selectContact
          ? {
              ...selectContact,
              birthday: selectContact.birthday ? dayjs(selectContact.birthday, 'MMM DD,YYYY') : '',
            }
          : {}
      }
      onFinish={onFinish}
    ...
    >
      <StyledContactFormHeader>
        ...
        {selectContact ? <StyledContactFormHeaderTitle>{selectContact.name}</StyledContactFormHeaderTitle> : null}
      </StyledContactFormHeader>
        ...
        <StyledContactFormContent>
          ...
          <StyledContactFormContentItem>
            ...
            <Form.Item className="form-field" name="notes">
              <Input.TextArea placeholder={messages['common.notes'] as string} />
            </Form.Item>
          </StyledContactFormContentItem>
        </StyledContactFormContent>

        <StyledContactFormFooter>
          <StyledContactFormBtn type="primary" ghost onClick={handleAddContactClose}>

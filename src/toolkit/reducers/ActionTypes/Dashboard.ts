...
export const GetAnalyticsAction = createAction<AnalyticsType>(GET_ANALYTICS_DATA);
...
export const GetHealthcareAction = createAction<HealthCareType>(GET_HEALTH_CARE_DATA);

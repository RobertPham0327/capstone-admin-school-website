...
export const ContactFolderListAction = createAction<FolderObjType[]>(GET_CONTACT_FOLDER_LIST);

export const ToggleContactAction = createAction(TOGGLE_CONTACT_DRAWER);

export const ContactLabelAction = createAction<LabelObjType[]>(GET_CONTACT_LABEL_LIST);
...
export const UpdateContactDetailsAction = createAction<ContactObjType>(UPDATE_CONTACT_DETAIL);

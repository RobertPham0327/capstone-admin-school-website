...
export const GetFolderListAction = createAction<FolderObjType[]>(GET_TODO_FOLDER_LIST);

export const TodoToggleDrawerAction = createAction<boolean>(TOGGLE_TODO_DRAWER);

export const GetTodoStatusAction = createAction<StatusObjType[]>(GET_TODO_STATUS_LIST);

export const GetTodoLabelAction = createAction<LabelObjType[]>(GET_TODO_LABEL_LIST);

export const GetTodoStaffAction = createAction<StaffObjType[]>(GET_TODO_STAFF_LIST);

export const GetTodoPriorityAction = createAction<PriorityObjType[]>(GET_TODO_PRIORITY_LIST);
...
export const UpdateTaskLabelAction = createAction<TodoObjType[]>(UPDATE_TASK_LABEL);

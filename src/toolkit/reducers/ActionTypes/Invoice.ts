...
export const GetInvoiceListAction = createAction<InvoiceType[]>(GET_INVOICE_LIST);

export const InvoiceDetailAction = createAction<InvoiceType>(GET_INVOICE_DETAIL);

export const InvoiceFolderAction = createAction<InvFolderType[]>(GET_INVOICE_FOLDER_LIST);

export const GetInvoiceSettingsAction = createAction<InvoiceSettingType>(GET_INVOICE_SETTINGS);
...
export const UpdateInvoiceSettingsAction = createAction<InvoiceType[]>(UPDATE_INVOICE_SETTINGS);
export const GetClientDetailAction = createAction<ClientType>(GET_CLIENT_DETAIL);
